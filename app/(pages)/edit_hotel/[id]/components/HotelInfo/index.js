...
export default function HotelInfo({onNext, onUpdate, defaultData}) {
  ...
  return (
    ...
    >
      ...
      <input
        ...
        value={hotelName || defaultData.name}
      ...
      <textarea
        ...
        rows={4}
        value={description || defaultData.description}
      ...
      <input
        ...
        value={rating || defaultData.rating}
